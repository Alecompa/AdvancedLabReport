The characterization of nuclide chart far from the stabilty valley is one of the
...
Another approch is based on cluster models, which, in
turn, are a posteriori methods that assume effective building blocks
(clusters).
...
Populating the board on one side connects the detector as $\Delta$E (Fig.~\ref{trace:dE}), while
populating on the other side connects the detector as E (Fig.~\ref{trace:E}).
